...
/**
 * Component for individual model cache card (under `ModelCacheManager`).
 */
export const ModelCacheCard = React.memo(({ verboseModelName, modelName, cacheSize, fetchModelsCache }: Props) => {
		...
		<Flex w='full' px='2' borderColor={borderColor} borderWidth='1px' rounded='sm' py='2' alignItems='baseline'>
			...
			<HStack>
				...
				<ReactTooltip
					...
					<Box as='span'>Delete {verboseModelName} Model&rsquo;s Cache</Box>
				</ReactTooltip>
			</HStack>
		</Flex>
	);
...
ModelCacheCard.displayName = 'ModelCacheCard';
