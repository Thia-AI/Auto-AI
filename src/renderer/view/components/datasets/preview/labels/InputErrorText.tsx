 ...
 */
export const InputErrorText = React.memo(({ isInputValid, inputError, clickedOnInputOnce, isInputFocused }: Props) => {
	return (
		<Box h='fit-content' px='1' w='full' pb='1.5'>
			<SlideFade unmountOnExit={true} offsetY='5px' in={!isInputValid && clickedOnInputOnce && isInputFocused}>
				<Badge
					display='flex'
					alignItems='center'
					borderRadius='md'
