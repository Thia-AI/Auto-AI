...
/**
 * Child under TransformWrapper for rendering a single image preview.
 */
export const SingleInputPreviewWrapperChild = React.memo(
	({
		resetTransform,
		centerView,
		zoomIn,
...
SingleInputPreviewWrapperChild.displayName = 'SingleInputPreviewWrapperChild';
