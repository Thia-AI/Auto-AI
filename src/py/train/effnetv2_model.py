...
from train import effnetv2_configs
# Here
...
def get_model(model_name,
    ...
    Args:
      ...
      save_path: A pathlib Path for directory to store the model.
      model_config: A dict of model configurations or a string of hparams.
      ...
      fname: Name of the directory/tar file to download model checkpoint to.
      If None, basename of model checkpoint URL is used.
    ...
    if model_name in pretrained_ckpts and weights in pretrained_ckpts[model_name]:
        ...
        download_fname = os.path.basename(url).split('.')[0]
        pretrained_ckpt = get_file(download_fname, url, untar=True, cache_subdir=save_path.absolute())
    else:
