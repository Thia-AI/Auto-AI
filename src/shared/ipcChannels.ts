...
export const IPC_NOTIFICATIONS_STORE_GET_NOTIFICATIONS = 'IPC_NOTIFICATIONS_STORE_GET_NOTIFICATIONS';

export const IPC_NOTIFICATIONS_STORE_RECEIVING_NOTIFICATIONS = 'IPC_NOTIFICATIONS_STORE_RECEIVING_NOTIFICATIONS';

export const IPC_NOTIFICATIONS_STORE_ADD_NOTIFICATION = 'IPC_NOTIFICATIONS_STORE_ADD_NOTIFICATION';

export const IPC_NOTIFICATIONS_STORE_DELETE_NOTIFICATION = 'IPC_NOTIFICATIONS_STORE_DELETE_NOTIFICATION';

export const IPC_NOTIFICATIONS_STORE_DELETE_NOTIFICATIONS = 'IPC_NOTIFICATIONS_STORE_DELETE_NOTIFICATIONS';
